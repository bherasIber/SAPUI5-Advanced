		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Types",
									"targetURL": "#logaligrouplisttypes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouplisttypes-display": {
								"semanticObject": "logaligrouplisttypes",
								"action": "display",
								"description": "List Types Fiori UI5",
								"title": "List Types",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.listtypes",
									"url": sap.ui.require.toUrl("logaligroup/listtypes")
								}
							}
						}
					}
